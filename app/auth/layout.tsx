    ...
    <div className="min-h-screen bg-[#080808] flex flex-col">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] opacity-15"
          style={{ background: "radial-gradient(circle, rgba(255,115,10,0.5) 0%, transparent 65%)" }} />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] opacity-10"
          style={{ background: "radial-gradient(circle, rgba(255,115,10,0.4) 0%, transparent 65%)" }} />
      </div>
